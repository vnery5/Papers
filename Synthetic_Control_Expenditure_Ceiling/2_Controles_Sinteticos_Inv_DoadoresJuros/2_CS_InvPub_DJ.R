...
### VENCEDOR: APENAS VALORES DE Y (0.98) ####
## Pesos e médias
lista_graficos_ApenasValoresY$pesos
ggsave("Figuras/Investimento_Publico/Pesos_InvPub_DJ.pdf", dpi = 1200)

## Trends e Gaps
lista_graficos_ApenasValoresY$trends
ggsave("Figuras/Investimento_Publico/Trends_InvPub_DJ.pdf", dpi = 1200)

lista_graficos_ApenasValoresY$gap
ggsave("Figuras/Investimento_Publico/Gap_InvPub_DJ.pdf", dpi = 1200)

## Inferência
lista_graficos_ApenasValoresY$placebos
ggsave("Figuras/Investimento_Publico/Placebos_InvPub_DJ.pdf", dpi = 1200)

lista_graficos_ApenasValoresY$razao_mspe
ggsave("Figuras/Investimento_Publico/Razao_MSPE_InvPub_DJ.pdf", dpi = 1200)
