...
dfNivel_InvTotCorrente_scpi <- scdata(
   dfNivel, 
...
# Estimando
cs_InvTotCorrente_scpi <- scest(dfNivel_InvTotCorrente_scpi, 
...
(mspe_pre_br_scpi <- funcs$mspe_pre_trat_scpi(cs_InvTotCorrente_scpi))

# Razão MSPE Pós-Tratamento
df_razao_mspe_scpi <- funcs$razao_mspe_scpi(df_placebos_scpi)
mspe_pos_scpi_demeaned <- mean(df_razao_mspe_scpi$post_mspe[
   df_razao_mspe_scpi$type == "donor"])

# Gráficos
lista_graficos_scpi <- funcs$graficos_sc_scpi(
   objeto_sc_scpi = cs_InvTotCorrente_scpi,
...
## 2010 ------------------------------------------------------------------------
# Preparando dados para o CS
dfNivel_InvTotCorrente_scpi_2010 <- scdata(
   dfNivel, 
   id.var = "iso2c", time.var = "Ano",
   outcome.var = "Investimento_PIB", 
...
# Estimando
cs_InvTotCorrente_scpi_2010 <- scest(dfNivel_InvTotCorrente_scpi_2010, 
                                     w.constr = list(name = "simplex", Q = 1))
...
## MSPE do Brasil pré-tratamento
(mspe_pre_br_scpi_2010 <- funcs$mspe_pre_trat_scpi(cs_InvTotCorrente_scpi_2010))
...
lista_graficos_scpi_2010 <- funcs$graficos_sc_scpi_temporal(
   objeto_sc_scpi = cs_InvTotCorrente_scpi_2010,
   ...
   paleta_trend = paleta_trend, paleta_gap = paleta_gap, 
   paleta_pesos = paleta_pesos, paleta_placebos = paleta_placebos,
   hjust_trends = .3, hjust_gap = .3
)

lista_graficos_scpi_2010$pesos

lista_graficos_scpi_2010$trends
ggsave("Figuras/Investimento_Total/Trends_Nivel_InvTotCorrente_2010.pdf", dpi = 1200)

lista_graficos_scpi_2010$gap
ggsave("Figuras/Investimento_Total/Gap_Nivel_InvTotCorrente_2010.pdf", dpi = 1200)


## 2014 ------------------------------------------------------------------------
# Preparando dados para o CS
dfNivel_InvTotCorrente_scpi_2014 <- scdata(
   dfNivel, 
   id.var = "iso2c", time.var = "Ano",
   outcome.var = "Investimento_PIB", 
...
# Estimando
cs_InvTotCorrente_scpi_2014 <- scest(dfNivel_InvTotCorrente_scpi_2014, 
                                     w.constr = list(name = "simplex", Q = 1))
...
## MSPE do Brasil pré-tratamento
(mspe_pre_br_scpi_2014 <- funcs$mspe_pre_trat_scpi(cs_InvTotCorrente_scpi_2014))
...
lista_graficos_scpi_2014 <- funcs$graficos_sc_scpi_temporal(
   objeto_sc_scpi = cs_InvTotCorrente_scpi_2014,
...
ggsave("Figuras/Investimento_Total/Trends_Nivel_InvTotCorrente_2014.pdf", dpi = 1200)

lista_graficos_scpi_2014$gap
ggsave("Figuras/Investimento_Total/Gap_Nivel_InvTotCorrente_2014.pdf", dpi = 1200)


# Leave-One-Out ================================================================
# Pegando maior peso
## Dados
dfPesos <- as.data.frame(cs_InvTotCorrente_scpi$est.results$w)
...
# Reestimando o CS
## Preparando dados para o CS
dfNivel_InvTotCorrente_scpi_LOO <- scdata(
   dfNivel_LOO, 
   id.var = "iso2c", time.var = "Ano",
   outcome.var = "Investimento_PIB", 
   period.pre = (nAnoInicial:nAnoTratamento),
...
## Estimando
cs_InvTotCorrente_scpi_LOO <- scest(dfNivel_InvTotCorrente_scpi_LOO, 
                                    w.constr = list(name = "simplex", Q = 1))
...
## MSPE do Brasil pré-tratamento
(mspe_pre_br_scpi_LOO <- funcs$mspe_pre_trat_scpi(cs_InvTotCorrente_scpi_LOO))
...
lista_graficos_scpi_LOO <- funcs$graficos_sc_scpi(
   objeto_sc_scpi = cs_InvTotCorrente_scpi_LOO,
...
ggsave("Figuras/Investimento_Total/Trends_Nivel_InvTotCorrente_LOO.pdf", dpi = 1200)

lista_graficos_scpi_LOO$gap
ggsave("Figuras/Investimento_Total/Gap_Nivel_InvTotCorrente_LOO.pdf", dpi = 1200)
